...
unsafe fn process_net_buffer_list(
    ...
    unsafe {
        // Extract the IP header size skipped by the system (usually >0 only for inbound and when flagged)
        ...
        while !current_nbl.is_null() {
            ...
            while !current_nb.is_null() {
                ...
                // After data is read, the NET_BUFFER pointer offset position must be restored
                if retreated {
...
pub unsafe extern "C" fn classify_network(
    ...
    let parsed_incoming_values = match parse_incoming_values_network(in_fixed_values) {
        Some(value) => value,
        None => {
            log!("got invalid layer in network classifyFn, should not happen");
            return;
        }
    };
...
fn parse_incoming_values_network(
    in_fixed_values: *const FWPS_INCOMING_VALUES0,
    ...
    unsafe {
        ...
        match (layer_id as i32) {
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_INBOUND_IPPACKET_V4 => {
                inbound = true;
                ipv4 = true;
                index_get_flags =
                    FWPS_FIELDS_INBOUND_IPPACKET_V4__FWPS_FIELD_INBOUND_IPPACKET_V4_FLAGS as usize;
                index_get_ifindex =
                    FWPS_FIELDS_INBOUND_IPPACKET_V4__FWPS_FIELD_INBOUND_IPPACKET_V4_INTERFACE_INDEX
                        as usize;
                index_get_sub_ifindex = FWPS_FIELDS_INBOUND_IPPACKET_V4__FWPS_FIELD_INBOUND_IPPACKET_V4_SUB_INTERFACE_INDEX
                    as usize;
            }
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_OUTBOUND_IPPACKET_V4 => {
                inbound = false;
                ipv4 = true;
                index_get_flags =
                    FWPS_FIELDS_OUTBOUND_IPPACKET_V4__FWPS_FIELD_OUTBOUND_IPPACKET_V4_FLAGS
                        as usize;
                index_get_ifindex = FWPS_FIELDS_OUTBOUND_IPPACKET_V4__FWPS_FIELD_OUTBOUND_IPPACKET_V4_INTERFACE_INDEX
                    as usize;
                index_get_sub_ifindex = FWPS_FIELDS_OUTBOUND_IPPACKET_V4__FWPS_FIELD_OUTBOUND_IPPACKET_V4_SUB_INTERFACE_INDEX
                    as usize;
            }
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_IPFORWARD_V4 => {
                inbound = false;
                ipv4 = true;
                index_get_flags = FWPS_FIELDS_IPFORWARD_V4__FWPS_FIELD_IPFORWARD_V4_FLAGS as usize;
                index_get_ifindex =
                    FWPS_FIELDS_IPFORWARD_V4__FWPS_FIELD_IPFORWARD_V4_DESTINATION_INTERFACE_INDEX
                        as usize;
                index_get_sub_ifindex = 0usize;
            }
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_INBOUND_IPPACKET_V6 => {
                inbound = true;
                ipv4 = false;
                index_get_flags =
                    FWPS_FIELDS_INBOUND_IPPACKET_V6__FWPS_FIELD_INBOUND_IPPACKET_V6_FLAGS as usize;
                index_get_ifindex =
                    FWPS_FIELDS_INBOUND_IPPACKET_V6__FWPS_FIELD_INBOUND_IPPACKET_V6_INTERFACE_INDEX
                        as usize;
                index_get_sub_ifindex = FWPS_FIELDS_INBOUND_IPPACKET_V6__FWPS_FIELD_INBOUND_IPPACKET_V6_SUB_INTERFACE_INDEX
                    as usize;
            }
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_OUTBOUND_IPPACKET_V6 => {
                inbound = false;
                ipv4 = false;
                index_get_flags =
                    FWPS_FIELDS_OUTBOUND_IPPACKET_V6__FWPS_FIELD_OUTBOUND_IPPACKET_V6_FLAGS
                        as usize;
                index_get_ifindex = FWPS_FIELDS_OUTBOUND_IPPACKET_V6__FWPS_FIELD_OUTBOUND_IPPACKET_V6_INTERFACE_INDEX
                    as usize;
                index_get_sub_ifindex = FWPS_FIELDS_OUTBOUND_IPPACKET_V6__FWPS_FIELD_OUTBOUND_IPPACKET_V6_SUB_INTERFACE_INDEX
                    as usize;
            }
            FWPS_BUILTIN_LAYERS__FWPS_LAYER_IPFORWARD_V6 => {
                inbound = false;
                ipv4 = false;
                index_get_flags = FWPS_FIELDS_IPFORWARD_V6__FWPS_FIELD_IPFORWARD_V6_FLAGS as usize;
                index_get_ifindex =
                    FWPS_FIELDS_IPFORWARD_V6__FWPS_FIELD_IPFORWARD_V6_DESTINATION_INTERFACE_INDEX
                        as usize;
                index_get_sub_ifindex = 0usize;
            }
        ...
        flags = incoming_value[index_get_flags]
            .value
            .__bindgen_anon_1
            .uint32;
        ifindex = incoming_value[index_get_ifindex]
            .value
            .__bindgen_anon_1
            .uint32;

        sub_ifindex = incoming_value[index_get_sub_ifindex]
            .value
            .__bindgen_anon_1
            .uint32;
    }
...
/// WFP Callout flow delete function - handles flow cleanup
pub unsafe extern "C" fn flow_delete_network(_layer_id: u16, _callout_id: u32, _flow_context: u64) {
